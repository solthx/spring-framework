...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	public ClassPathXmlApplicationContext(
			...
			throws BeansException {
		// 使用组合的方式，设置PathMatchingResourcePatternResolver
		// ps: 因为configLocations是数组类型的，所以解析得到的也是Resource[]类型的，
		// 所以使用的是PathMatchingResourcePatternResolver
		super(parent);
		// 读取configLocations并保存其信息
