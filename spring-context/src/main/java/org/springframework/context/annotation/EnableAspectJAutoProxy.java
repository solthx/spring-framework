...
@Documented
// 通过实现ImportBeanDefinitionRegistrar接口，利用registrar来注册一个Bean
// 其接口类型为：AUTO_PROXY_CREATOR_BEAN_NAME：
// 		org.springframework.aop.config.internalAutoProxyCreator
// 其实际注入的类型为：AnnotationAwareAspectJAutoProxyCreator.class
// 接下来就是开始研究 AnnotationAwareAspectJAutoProxyCreator 的作用
