...
//		Assert.notNull(environment, "Environment must not be null");
	...
	<T> void doRegisterBean(Class<T> annotatedClass, @Nullable Supplier<T> instanceSupplier, @Nullable String name,
		...
		/*===================上面做的事情，主要就是根据注解来配置BeanDefinition的信息=============================*/

		/*=====================================下面的做的事情就是真正的注册了====================================== */

		/**
		 * 看到了这个BeanDefinitionHolder是不是就很亲切！
		 * 它就是 <BeanName, BeanDefinition>
		 */
		...
		/**
		 * 在前面生成Reader的过程中，其实就已经创建过DefaultListableBeanFactory了
		 * 然后又得到了BeanDefinition，
		 * 所以接下来就可以进行注册了..
		 */
