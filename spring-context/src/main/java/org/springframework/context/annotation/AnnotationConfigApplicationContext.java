...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		/**
		 * 生成了AnnotatedBeanDefinitionReader
		 *
		 * 创建了BeanFactory（DefaultListableBeanFactory）
		 * ps: 在XML配置方式，BeanFactory是在refresh里的generateBeanFactory里生成的.
		 */
	...
	public AnnotationConfigApplicationContext(Class<?>... annotatedClasses) {
		// 在自己构造方法中初始一个读取器和扫描器
		// 已经生成了DefaultListableBeanFactory
		this();
		// 在这一步，扫描注解的信息，并生成BeanDefinition，然后注册BeanDefinition
